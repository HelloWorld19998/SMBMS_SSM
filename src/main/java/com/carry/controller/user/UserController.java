...
public class UserController {
    ...
    @RequestMapping("/jsp/pwdmodify.jsp")
    ...
    public String updatePwd(String newpassword, HttpServletRequest req, ModelAndView modelAndView){
        //从Session里面拿id
    ...
    public String pwdModify(String oldpassword, HttpServletRequest req, HttpServletResponse resp) {
        //从Session里面拿ID；
        User attribute = (User) req.getSession().getAttribute(USER_SESSION);
    ...
    //跳转到添加用户界面
    @RequestMapping("/jsp/useradd.jsp")
    ...
    public void getRoleList(HttpServletResponse resp) throws IOException {
        List<Role> roleList = roleService.getRoleList();
    ...
    public String getUserById(String uid, HttpServletRequest req){
        //调用后台方法得到user对象
    ...
    public String toModify(String uid, HttpServletRequest req){
        //调用后台方法得到user对象
        User user = userService.getUserById(Integer.parseInt(uid));
        req.setAttribute("user",user);
        return "usermodify";
    ...
    public String modify(String uid, String userName, String gender, String birthday, String phone, String address, String userRole, HttpServletRequest req, RedirectAttributes attributes) throws ParseException {
        User user = new User();
